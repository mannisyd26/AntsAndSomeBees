...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        place = self.place
        distance = 0
        while place != hive or place.entrance:
...
class QueenPlace:
    ...
    def __init__(self, colony_queen, ant_queen):
        self.current = colony_queen
        self.original = ant_queen

    @property
    def bees(self):
        return self.current.bees + self.original.bees
...
class QueenAnt(ScubaThrower):
    ...
    def action(self, colony):
        ...
        if not self.imposter:
            ...
            while (curr_place):
                if curr_place.ant:
                    if curr_place.ant not in self.ant_list:
                        curr_place.ant.damage *= 2
                        if curr_place.ant.container:
                            curr_place.ant.ant.damage *= 2
                            self.ant_list.append(curr_place.ant.ant)
                        self.ant_list.append(curr_place.ant)
